...
//        this.jd.setVisible(true);
    ...
    public void run()
    {
        try
        {
            this.filePath = System.getProperty("user.home") + "/dl4j-examples-data/dl4j-examples/PredictGender/";
//            this.filePath = System.getProperty("user.dir") + "\\src\\main\\resources\\PredictGender\\Data\\";
            ...
            File infile = new File(this.filePath + "PredictGender.net");
            System.out.println("model path: " + infile.getAbsolutePath() );
            model = MultiLayerNetwork.load(infile, true);
